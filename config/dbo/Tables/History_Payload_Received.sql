CREATE TABLE [dbo].[History_Payload_Received] (
    [Payload_Received_ID]     INT            NOT NULL,
...
CREATE CLUSTERED INDEX [ix_History_File_Received]
    ON [dbo].[History_Payload_Received]([ValidTillFR] ASC, [ValidFromFR] ASC) WITH (DATA_COMPRESSION = PAGE);
